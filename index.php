...
<head>
    ...
    <title>Rim Caffe & Restaurant | Home</title>
    ...
    <style>
        ...
        .hero-title {
            ...
            line-height: 1.1;
            font-weight: 700;
            /* Margin Top & Bottom as requested */
            margin-top: 30px; 
            margin-bottom: 30px; 
        }

        /* Logic to force two lines on large screens */
        .hero-title span {
            display: block; 
            color: var(--gold);
        }
        ...
        @media (max-width: 768px) {
            ...
            .hero-title span {
                display: inline; /* Let it flow naturally on phones */
            }
        }
        ...
        <div class="container">
            <div class="hero-text w-100 mx-auto"> 
                ...
                <h1 class="text-white text-center hero-title mx-auto">
                    Welcome to <span>Rim Caffe & Restaurant</span>
                </h1>
...
<section id="featured" class="container py-5 mt-5">
    <div class="section-header">
        <div>
            <h2 style="color: var(--gold); font-family: 'Playfair Display'; font-size: 2.5rem; margin: 0;">Featured Selection</h2>
            <p class="text-secondary mb-0">Experience our most popular handcrafted items.</p>
        </div>
    ...
    <div class="row g-4">
        <?php
        $query = "SELECT * FROM menu WHERE is_available = 1 ORDER BY id DESC LIMIT 6";
